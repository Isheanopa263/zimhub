...
CREATE INDEX IF NOT EXISTS idx_queries_last_reply
  ON queries(last_reply_at DESC);
CREATE INDEX IF NOT EXISTS idx_queries_user_status
  ON queries(user_id, status);
CREATE INDEX IF NOT EXISTS idx_replies_query_id
  ON query_replies(query_id, created_at);
CREATE INDEX IF NOT EXISTS idx_replies_unread
  ON query_replies(query_id, is_read);

-- Suggestions
CREATE INDEX IF NOT EXISTS idx_suggestions_created
  ON suggestions(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_suggestions_read
  ON suggestions(is_read);
CREATE INDEX IF NOT EXISTS idx_suggestions_archived
  ON suggestions(is_archived);
